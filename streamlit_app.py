...
def google_trends_page(merged_df, trend_subset_US_df, trend, trend_subset_state_df, year_range, states):
...
def main():
    ...
    if page == "Overview":
      ...
      google_trends_page(merged_df, trend_subset_US_df, trend, trend_subset_state_df, year_range, states)
