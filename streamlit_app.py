...
regression_line = chart8.transform_regression('Annual_Avg_Trend_Value','Mortality_Rate',method="linear",extent[0,90]).mark_line().encode(
    color="grey",
    strokeDash=[5,5]
...
#combined_chart = alt.vconcat(chart7,chart8+ chart8.transform_regression('Annual_Avg_Trend_Value','Mortality_Rate').mark_line())
